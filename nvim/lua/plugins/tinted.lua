return {
  ...
  config = function()
    ...
    local function apply_overrides()
      ...
      vim.cmd('hi clear @string.special.path.nix') -- Clear for paths like ./containers in Nix
      ...
      vim.api.nvim_set_hl(0, "@string.special.path.c", { fg = "#FDF0D5", bg = "NONE" }) -- Off-white for paths like stdio.h
      ...
      vim.cmd('hi clear @string.special.path.nix')
      vim.api.nvim_set_hl(0, "@string.special.path.nix", { fg = "#FDF0D5", bg = "NONE" }) -- Off-white for paths like ./containers (higher contrast for dots)
